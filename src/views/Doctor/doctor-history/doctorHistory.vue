<template>
    <div class="h-[100vh] w-full bg-[url(https://res.cloudinary.com/dl0wt2mgx/image/upload/v1687143567/project_booking/slide-website-nganh-y-te-768x384_ytkx3m.jpg)]">
        <div className="flex px-[10%] mb-10 ">
            <div className="w-full">
            </div>
            <div class="w-full">
                <label for="datepicker" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white text-white"
            ...
            <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                <thead className="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                    <tr>
                        ...
                        <th scope="col" className="px-6 py-3">{{ $t('label.details') }}</th>
                    </tr>
                </thead>
                <tbody>
                    <tr
