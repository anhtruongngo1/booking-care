<template>
    <div className="w-[30%]">
        <label className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">{{ $t('label.priceMethod')}}</label>
        <select
        ...
        >
            <option disabled selected value="">{{ $t('label.priceMethod')}}</option>
