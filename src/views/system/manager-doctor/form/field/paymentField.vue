<template>
    <div className="w-[30%] ml-[2%]">
        <label className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">{{ $t('label.paymentMethod')}}</label>
        <select
        ...
        >
            <option disabled selected value="">{{ $t('label.paymentMethod')}}</option>
